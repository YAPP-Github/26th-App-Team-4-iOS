//
//  MyRunningCountViewController.swift
//  Presentation
//
...
public final class MyRunningCountViewController: BaseViewController, View {
  ...
  private let goalRunningCountView = GoalRunningCountView()

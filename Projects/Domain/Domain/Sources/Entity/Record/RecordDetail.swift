...
public struct RecordDetail {
  ...
  public static let dummy = RecordDetail(
    ...
    imageURL: URL(string: "https://firebasestorage.googleapis.com/v0/b/maumnote-dev.firebasestorage.app/o/dfgdfadgdaf.png?alt=media&token=6efbf829-830d-47eb-8f47-058fa258b14a"),
